...
## Sobre esta atualização (o esquema do banco mudou)

Esta versão alterou a estrutura interna do banco de dados (para suportar mais de 1 palavra por dia). Como o app ainda está em fase de testes, a atualização usa `fallbackToDestructiveMigration()` — ou seja, **seu histórico de palavras aprendidas será apagado** na primeira abertura após atualizar para esta versão. Deve acontecer só nesta migração específica.
