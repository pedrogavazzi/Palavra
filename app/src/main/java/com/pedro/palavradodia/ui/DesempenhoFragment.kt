...
class DesempenhoFragment : Fragment() {
    ...
    private fun loadStats() {
        ...
        lifecycleScope.launch {
            ...
            if (stats.testedCount == 0) {
                addText("📊 Suas estatísticas completas de desempenho aparecerão aqui depois que você concluir seu primeiro ciclo de 7 dias (fazendo o primeiro teste semanal). Continue aprendendo palavras na aba \"Hoje\"!")
            }
            ...
            for (group in groups) {
                ...
                tv.textSize = 15f
                tv.setTextColor(androidx.core.content.ContextCompat.getColor(requireContext(), com.pedro.palavradodia.R.color.primary_dark))
    ...
    private fun addText(text: String) {
        ...
        tv.text = text
        tv.textSize = 15f
        tv.setTextColor(androidx.core.content.ContextCompat.getColor(requireContext(), com.pedro.palavradodia.R.color.text_primary))
